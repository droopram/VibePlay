import { Vector3, PerspectiveCamera, Euler, Raycaster } from "three";
...
export class FirstPersonController implements Disposable {
   ...
   */
  private _checkPlatformCollision(): void {
    ...
    if (intersects.length > 0) {
      ...
      console.log(
        `Distance to ground: ${distanceToGround}, Player height: ${playerHeight}`
      );
